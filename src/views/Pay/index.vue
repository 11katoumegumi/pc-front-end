  ...
  <div class="pay-main">
    <div class="pay-container">
        ...
        <div class="paymark">
          ...
          <span class="fr"
            ...
            ><em class="orange money"
              >￥{{ $route.query.originalTotalAmount }}</em
            ></span
          >
        </div>
      </div>
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" @click="handlePayClick">立即支付</a>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
    ...
    <Dialog title="微信支付" width="30%" :visible.sync="visible">
      <span><img v-lazy="qrCode" alt="二维码" /></span>
      <template #footer>
        <button class="left">按钮1</button>
        <button class="right">按钮2</button>
      </template>
    </Dialog>
  </div>
</template>
