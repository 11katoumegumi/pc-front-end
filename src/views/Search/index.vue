        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="$route.params.keyword">
              {{ $route.params.keyword }}<i @click="deleteKeyword">x</i>
            </li>
            ...
            <li class="with-x" v-if="options.trademark">
              {{ options.trademark.split(":")[1] }}<i>x</i>
            </li>
            <li
              class="with-x"
...
export default {
  ...
  methods: {
    ...
    searchProps(props) {
      if (this.options.props.includes(props)) {
        return;
      }
    ...
    deleteprop(index) {
      this.options.props.slice(index, 1);
      this.search();
    },
    setOrder(orderName) {
      let orderType = "desc";
      ...
      if (orderName == this.order[0]) {
        orderType = this.order[1] === "asc" ? "desc" : "asc";
      }
